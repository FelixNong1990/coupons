...
function fl_social_share() {
	...
	<ul class="inner-social">
		...
		<li><a class="twitter" href="#" onclick="window.open('http://twitter.com/home?status=<?php echo urlencode($post->post_title); ?>:%0a<?php the_permalink(); ?> via @Scouping','twitter-share-dialog','width=670,height=436');return false;" rel="nofollow" target="_blank"><?php _e( 'Twitter', APP_TD ); ?></a></li>
